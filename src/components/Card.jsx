...
function Card() {
  return (
    <div className="bg-card border-black p-4 rounded-tl-3xl shadow-lg flex flex-col h-full items-center mt-8 md:mt-0 w-full md:w-auto md:flex-1">
      <div className="max-w-lg">
        <Carousel autoSlide={true} photos={photos} />
      </div>
      <div className="flex flex-row md:flex-col justify-center items-center space-x-2 mt-4">
