...
function Header() {
   return (
    <header className="flex justify-between items-center my-5 mx-10 rounded-lg bg-gray-100 shadow-md">
 ...
 <nav className="flex items-center p-2 mr-5 text-lg space-x-4 sm:space-x-6">
  ...
  <a href="https://tonda-circle.beehiiv.com/" className="hover:underline" target='_blank'>Blog</a>
